...
namespace Fur_Affinity.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Home".GetLocalized(), Symbol.Home, typeof(HomeViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Forums".GetLocalized(), Symbol.People, typeof(ForumsViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Info".GetLocalized(), Symbol.Important, typeof(InfoViewModel).FullName));
            _secondaryItems.Add(new ShellNavigationItem("Shell_Settings".GetLocalized(), Symbol.Setting, typeof(SettingsViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Notifications".GetLocalized(), Symbol.Message, typeof(NotificationsViewModel).FullName));
        }
